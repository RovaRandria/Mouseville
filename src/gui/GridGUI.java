...
public class GridGUI extends JPanel {
	...
	public GridGUI() {
		try {
			maleMouseSpriteSheet = ImageIO.read(new File("./src/pictures/sprites/MaleMouseSprite.png"));
			femaleMouseSpriteSheet = ImageIO.read(new File("./src/pictures/sprites/FemaleMouseSprite.png"));
			floorSprite = ImageIO.read(new File("./src/pictures/sprites/Parquet.png"));
			foodSprite = ImageIO.read(new File("./src/pictures/sprites/food.png"));
			targetSprite = ImageIO.read(new File("./src/pictures/sprites/target.png"));
			obstacles.put("Wood",ImageIO.read(new File("./src/pictures/sprites/wood.png")));
			obstacles.put("Table",ImageIO.read(new File("./src/pictures/sprites/table.png")));
			obstacles.put("Barrel",ImageIO.read(new File("./src/pictures/sprites/barrel.png")));
			obstacles.put("Box",ImageIO.read(new File("./src/pictures/sprites/box.png")));
			obstacles.put("Hole",ImageIO.read(new File("./src/pictures/sprites/hole.png")));
			mouseParquet = ImageIO.read(new File("./src/pictures/sprites/NegaParquet.png"));
			mouseObstacle = ImageIO.read(new File("./src/pictures/sprites/negawood.png"));
			mouseFood = ImageIO.read(new File("./src/pictures/sprites/NegaFood.png"));
		} catch (IOException e) {
