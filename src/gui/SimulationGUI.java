...
public class SimulationGUI extends JFrame implements Runnable, MouseListener {
	...
	ImageIcon cheeseIcon = new ImageIcon("./src/pictures/icons/generationIcon.png");
	ImageIcon catIcon = new ImageIcon("./src/pictures/icons/chat.png");
	ImageIcon infoIcon = new ImageIcon("./src/pictures/icons/infobulle.png");
	ImageIcon logIcon = new ImageIcon("./src/pictures/icons/logIcon.png");
	ImageIcon statsIcon = new ImageIcon("./src/pictures/icons/statsicon.png");
	ImageIcon simIcon = new ImageIcon("./src/pictures/icons/clef.png");
	...
	private class InfosPanel extends JPanel {
		...
		private class ChangeFoodAction implements ActionListener {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Statistics.globalStatistics.setTotalFoodQuantity(Statistics.globalStatistics.getTotalFoodQuantity()+Integer.parseInt(foodField.getText()));
				gridGUI.repaint();
			}
		}
	}
